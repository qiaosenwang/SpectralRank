...
n = 100
L_list = [1, 5, 10, 20, 50, 100, 200, 500, 1000, 2000]
model_list = ["Thurstone"] # list of simulated models
delta = 1/3
...
plt.suptitle("Thurstone fixed max-gap=5, "+r'$p=0.95,\ n=100$')
plt.subplot(121)
mean_list = sr_mean_dict["Thurstone"]
sd_list = sr_sd_dict["Thurstone"]
...
mean_list = rg_mean_dict["Thurstone"]
sd_list = rg_sd_dict["Thurstone"]
plt.plot(L_list, mean_list, label="regularized rank centrality", marker='.', linewidth=1)
plt.fill_between(L_list, np.array(mean_list)-np.array(sd_list), np.array(mean_list)+np.array(sd_list), alpha=0.1)
mean_list = bc_mean_dict["Thurstone"]
sd_list = bc_sd_dict["Thurstone"]
...
plt.subplot(122)
mean_list = sr_mean_dict["Thurstone"]
plt.plot(np.log(L_list), np.log(mean_list), label="rank centrality", marker='.', linewidth=1)
mean_list = rg_mean_dict["Thurstone"]
plt.plot(np.log(L_list), np.log(mean_list), label="regularized rank centrality", marker='.', linewidth=1)
mean_list = bc_mean_dict["Thurstone"]
plt.plot(np.log(L_list), np.log(mean_list), label="Borda count", marker='.', linewidth=1)
plt.xlabel(r'$\log L$')
plt.ylabel(r'$\log\tau$')
plt.grid(True)
plt.legend()
...
plt.savefig('./fig/compare_L_borda_ths_fixmax.png', dpi=800)
...
plt.subplots_adjust(hspace=0.5, wspace=0.5)
plt.figure(figsize=(10, 6))
plt.suptitle("Thurstone fixed min-gap=0.1, "+r'$p=0.95,\ n=100$')
plt.subplot(121)
mean_list = sr_mean_dict["Thurstone"]
sd_list = sr_sd_dict["Thurstone"]
plt.plot(L_list, mean_list, label="rank centrality", marker='.', linewidth=1)
...
plt.savefig('./fig/compare_L_borda_ths_fixmin.png', dpi=800)
