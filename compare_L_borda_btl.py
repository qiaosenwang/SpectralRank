...
plt.suptitle("Bradley-Terry fixed max-gap=5, "+r'$p=0.95,\ n=100$')
plt.subplot(121)
...
plt.savefig('./fig/compare_L_borda_btl_fixmax.png', dpi=800)
...
plt.savefig('./fig/compare_L_borda_btl_fixmin.png', dpi=800)
