...
plt.suptitle("Thurstone fixed max-gap=5, "+r'$p=1.1\log n/n$')
plt.subplot(121)
...
plt.savefig('./fig/compare_borda_ths_fixmax.png', dpi=800)
...
plt.subplots_adjust(hspace=0.5, wspace=0.5)
plt.figure(figsize=(10, 6))
plt.suptitle("Thurstone fixed min-gap=0.1, "+r'$p=1.1\log n/n$')
plt.subplot(121)
mean_list = sr_mean_dict["Thurstone"]
sd_list = sr_sd_dict["Thurstone"]
plt.plot(n_list, mean_list, label="rank centrality", marker='.', linewidth=1)
...
plt.savefig('./fig/compare_borda_ths_fixmin.png', dpi=800)
